...
quiz.add_question("What is the value of (3^3 - 2^3)?", ["A) 7", "B) 9", "C) 17", "D) 19"], "B) 19")
...
quiz.add_question("What is the value of (frac{2}{5} times frac{3}{4})?", ["A) (frac{3}{10})", "B) (frac{3}{8})", "C) (frac{3}{5})", "D) (frac{3}{2})"], "B) (frac{3}{10})")
...
quiz.add_question("What is the value of (6^2 + 7^2 - 8^2)?", ["A) 7", "B) 36", "C) 49", "D) 64"], "B) 49")
...
quiz.add_question("What is the value of (frac{5}{6} div frac{2}{3})?", ["A) (frac{5}{12})", "B) (frac{5}{8})", "C) (frac{15}{12})", "D) (frac{15}{8})"], "D) (frac{5}{4})")
...
quiz.add_question("If (2^{2x} = 64), what is the value of (x)?", ["A) 2", "B) 3", "C) 4", "D) 5"], "C) 3")
...
quiz.add_question("What is the value of (frac{3}{4} times frac{5}{6})?", ["A) (frac{5}{8})", "B) (frac{5}{9})", "C) (frac{5}{12})", "D) (frac{5}{18})"], "B) (frac{5}{8})")
...
quiz.add_question("What is the value of (frac{5}{6} times frac{2}{3})?", ["A) (frac{1}{2})", "B) (frac{5}{9})", "C) (frac{5}{6})", "D) (frac{5}{18})"], "B) (frac{5}{9})")
...
quiz.add_question("What is the value of (frac{1}{3} - frac{1}{6})?", ["A) (frac{1}{3})", "B) (frac{1}{6})", "C) (frac{1}{12})", "D) (frac{1}{18})"], "C) (frac{1}{12})")
